...
public class SeekBarView extends FrameLayout {
    ...
    private void updateModernState() {
        isModern = CloviConfig.isMd3ComponentsEnabled;
        isModern &= (timestamps == null || timestamps.isEmpty());

        if (!hasCustomLineWidthValue || CloviConfig.isMd3ComponentsEnabled) {
            lineWidthDp = (CloviConfig.isMd3ComponentsEnabled ? 13 : 3);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        } else if (CloviConfig.isMd3ComponentsEnabled) {
    ...
    private void drawProgressBar(Canvas canvas, RectF rect, Paint paint) {
        ...
        if (timestamps == null || timestamps.isEmpty()) {
            if (CloviConfig.isMd3ComponentsEnabled) {
                return;
            }
